    ...
    <div class="nk-block nk-block-lg">
        ...
        <div class="card">
            <div class="card-inner">
                ...
                <form action="{{ route('ip.store') }}" method="post" enctype="multipart/form-data" id="form">
                    @csrf
                    <div class="row g-4">
                        <div class="col-lg-6">
                                ...
                                <select class=" select-2 form-control form-control-sm " id="select_tejari">
                                    ...
                                    @foreach ($tejaris as $tejari)
                                        <option value="{{ $tejari->id }}"
                                            data-url='{{ route('ip.get-vlan', ['tejari' => $tejari->id]) }}'
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" readonly id="vlan" name="vlan"
                                        value="{{ old('vlan') }}">
                                </div>
                            </div>
                            @error('vlan')
