    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h4 class="nk-block-title">لیست تلفن واحد ها </h4>
                <div class="nk-block-des">
                    <a href="{{ route("phone.create") }}" class="btn btn-dim btn-outline-info">ساخت تلفن جدید</a>
                </div>
            </div>
        </div>
                ...
                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                    <thead>
                        <tr class="nk-tb-item nk-tb-head">
                            ...
                            <th class="nk-tb-col "><span class="sub-text">ایپی تلفن</span></th>
                            ...
                            <tr class="nk-tb-item">
                                ...
                                <td class="nk-tb-col">
                                    <div class="user-card">
                                        ...
                                        <div class="user-info">
                                            <span class="tb-lead">{{ $phone->tejari->name ?? '' }} <span
                                ...
                                <td class="nk-tb-col" data-order="35040.34">
                                    <span class="tb-amount">{{ $phone->tejari->unit ?? '' }}</span>
                                </td>
                                <td class="nk-tb-col " data-order="35040.34">
                                    <span class="tb-amount">طبقه{{ convertEnglishToPersian($phone->tejari->floor) ?? '' }}</span>
                                </td>
                                <td class="nk-tb-col ">
                                ...
                                <td class="nk-tb-col ">
                                    <span class="tb-status text-success">{{ $phone->ip ?? '' }}</span>
                                </td>
                                <td class="nk-tb-col ">
                                    <span class="tb-status ">{{ $phone->user ?? '' }}</span>
                                </td>
                                <td class="nk-tb-col ">
                                    <span class="tb-status ">{{ $phone->password ?? '' }}</span>
                                </td>
                                ...
                                <td class="nk-tb-col ">
                                    <div class="custom-control custom-checkbox checked">
                                        <input type="checkbox" class="custom-control-input"
                                            ...
                                            data-url="{{ route("phone.status", $phone->id) }}" name="status"
                                            @if ($phone->status == 1) checked @endif id="{{ $phone->id }}">
                                        <label class="custom-control-label" for="{{ $phone->id }}"></label>
                                    </div>
                                </td>
