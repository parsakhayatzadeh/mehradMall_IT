    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h4 class="title nk-block-title">ویرایش تلفن </h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="" name="password"
                                        value="{{ old('password', $phone->password) }}">
                                </div>
                            </div>
                            @error('password')
                                <span class=" alert_requerd  bg-danger text-white p-1 rounded " role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <select class="form-control" id="status" name="status">
                                        <option value="0" @if (old('status', $phone->status) == '0') selected @endif>غیر فعال
                                        </option>
                                        <option value="1" @if (old('status', $phone->status) == '1') selected @endif>فعال
                                        </option>
                                    </select>
                                </div>
                            </div>
