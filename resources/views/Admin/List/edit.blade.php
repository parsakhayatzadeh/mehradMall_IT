    ...
    <div class="nk-block nk-block-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                <h4 class="title nk-block-title">ویرایش واحد </h4>
        ...
        <div class="card">
            <div class="card-inner">
                ...
                <form action="{{ route('list.update' , $tejari->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("put")
                    <div class="row g-4">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <select class="form-control" id="status" name="status">
                                        <option value="0" @if (old('status' , $tejari->status) == '0') selected @endif>غیر فعال
                                        </option>
                                        <option value="1" @if (old('status' , $tejari->status) == '1') selected @endif>فعال
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="" name="phone"
                                        value="{{ old('phone' , $tejari->phone->phone ?? '') }}">
                                </div>
                            </div>
                            @error('phone')
                                <span class=" alert_requerd  bg-danger text-white p-1 rounded " role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="" name="vlan"
                                        value="{{ old('vlan' , $tejari->vlan->vlan ?? '') }}">
                                </div>
                            </div>
                            @error('vlan')
                                <span class=" alert_requerd  bg-danger text-white p-1 rounded " role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="" name="port_sw"
                                        value="{{ old('port_sw', $tejari->vlan->port_sw ??"") }}">
                                </div>
                            </div>
                            @error('port_sw')
                                <span class=" alert_requerd  bg-danger text-white p-1 rounded " role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control"  id="internet_speed" name="internet_speed"
                                        value="{{ old('internet_speed' ,  $tejari->routerr->internet_speed ?? '') }}">
                                </div>
                            </div>
